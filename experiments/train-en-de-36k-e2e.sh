...
#SBATCH --output=36k-en-de-%j.out
#SBATCH --error=36k-en-de-%j.err
...
APE_DATA_DIR="/home/xvuthith/da33/trang/dataset/en_de/APE18_LIG"
...
WK_DIR="/home/xvuthith/da33/trang/jobs/experiment/36k-end2end-"$DATE
mkdir -p $WK_DIR
