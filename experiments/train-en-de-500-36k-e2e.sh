...
#SBATCH --output=500-36k-small-%j.out
#SBATCH --error=500-36k-small-%j.err
...
WK_DIR="/home/xvuthith/da33/trang/jobs/experiment/500-36k-end2end-"$DATE
mkdir -p $WK_DIR
